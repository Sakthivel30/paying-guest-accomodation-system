...
$query=mysqli_query($con, "insert into tblusers(FirstName,LastName, MobileNumber, Email, Address,Hostel,Tenant,ProfilePic) value('$fname','$lname', '$contno', '$email', '$add','$hostel','$tenant','$imgnewfile' )");
if ($query) {
echo "<script>alert('You have successfully inserted the data');</script>";
echo "<script type='text/javascript'> document.location ='new.php'; </script>";
} else{
...
<div class="signup-form">
    <form  method="POST" enctype="multipart/form-data" >
		<h2>Fill Data</h2>
		<p class="hint-text">Fill Tenant Detail</p>
		...
		<div class="form-group">
            <input class="form-control" name="text1" placeholder="hostel name" required="true"></textarea>
        </div>

		<div class="form-group">
            <input class="form-control" name="text2" placeholder="tenanttype" required="true"></textarea>
        </div>
             <div class="form-group">
	...
	<div class="text-center">View Aready Inserted Data!!  <a href="new.php">View</a></div>
</div>
</body>
</html>